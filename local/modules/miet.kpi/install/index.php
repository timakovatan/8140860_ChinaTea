...
Class miet_kpi extends CModule {
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("TEAS_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("TEAS_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("TEAS_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("TEAS_PARTNER_URI");
    }
